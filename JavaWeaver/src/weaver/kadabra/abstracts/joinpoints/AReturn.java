...
/**
 * Auto-Generated class for join point AReturn
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AReturn extends AStatement {
     ...
     * 
     */
    public AReturn(AStatement aStatement){
     ...
     * 
     */
    protected enum ReturnAttributes {
        ENDLINE("endLine"),
        KIND("kind"),
         ...
         * 
         */
        private ReturnAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ReturnAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ReturnAttributes::name).collect(Collectors.toList());
        }
