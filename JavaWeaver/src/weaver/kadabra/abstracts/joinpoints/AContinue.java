...
/**
 * Auto-Generated class for join point AContinue
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AContinue extends AStatement {
     ...
     * 
     */
    public AContinue(AStatement aStatement){
     ...
     * 
     */
    protected enum ContinueAttributes {
        KIND("kind"),
        ENDLINE("endLine"),
        PARENT("parent"),
         ...
         * 
         */
        private ContinueAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ContinueAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ContinueAttributes::name).collect(Collectors.toList());
        }
