...
/**
 * Auto-Generated class for join point AThrow
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AThrow extends AStatement {
     ...
     * 
     */
    public AThrow(AStatement aStatement){
     ...
     * 
     */
    protected enum ThrowAttributes {
        KIND("kind"),
        ENDLINE("endLine"),
        PARENT("parent"),
        ISSTATIC("isStatic"),
         ...
         * 
         */
        private ThrowAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ThrowAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ThrowAttributes::name).collect(Collectors.toList());
        }
