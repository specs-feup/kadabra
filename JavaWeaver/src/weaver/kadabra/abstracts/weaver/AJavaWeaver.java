...
public abstract class AJavaWeaver extends WeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"insertBefore", "insertBefore", "insertAfter", "insertAfter", "insertReplace", "insertReplace", "replaceWith", "replaceWith", "copy", "remove", "removeAnnotation", "setText", "setAttribute", "newClass", "newClass", "newInterface", "newInterface", "addImport", "addClass", "addInterface", "mapVersions", "setName", "newConstructor", "newMethod", "newMethod", "insertMethod", "insertCode", "newFunctionalClass", "insertStatic", "extractInterface", "addImplement", "newField", "newField", "addComment", "addParameter", "createAdapter", "clone", "clone", "setArguments", "setArguments", "tile", "tile", "interchange", "setInit", "setLhs", "setRhs", "extract", "setInit", "insertBegin", "insertBegin", "setOperator", "setOperator", "setValue"};
