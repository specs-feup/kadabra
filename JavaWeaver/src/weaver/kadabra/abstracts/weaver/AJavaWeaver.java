...
public abstract class AJavaWeaver extends LaraWeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"copy", "insertAfter", "insertAfter", "insertBefore", "insertBefore", "insertReplace", "insertReplace", "remove", "removeAnnotation", "removeModifier", "replaceWith", "replaceWith", "setLine", "setLine", "setModifiers", "setText", "extract", "setTest", "setTest", "setName", "mapVersions", "newClass", "newClass", "newInterface", "newInterface", "setLhs", "setRhs", "setOperator", "insertBegin", "insertBegin", "clone", "setArgument", "setArguments", "setExecutable", "setTarget", "setTarget", "extractInterface", "insertStatic", "mapVersions", "newConstructor", "newFunctionalClass", "addClass", "addImplement", "addInterface", "insertCode", "insertMethod", "newField", "newField", "newMethod", "newMethod", "removeInterface", "setInit", "addClass", "addImport", "addInterface", "mapVersions", "newClass", "newClass", "newInterface", "newInterface", "removeInterface", "setValue", "setInit", "interchange", "tile", "tile", "addComment", "addParameter", "clone", "createAdapter", "setPrivacy", "setArguments", "setOperator", "setLine", "setLine", "setOperator", "setAttribute"};
