...
public abstract class AJavaWeaver extends LaraWeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"getChild", "getAncestor", "hasModifier", "insertBefore", "insertBefore", "insertAfter", "insertAfter", "insertReplace", "insertReplace", "replaceWith", "replaceWith", "copy", "remove", "removeAnnotation", "setText", "getElements", "getAttribute", "setAttribute", "showAST", "newClass", "newClass", "newInterface", "newInterface", "addClass", "addInterface", "removeInterface", "mapVersions", "setName", "newConstructor", "newMethod", "newMethod", "insertMethod", "insertCode", "newFunctionalClass", "insertStatic", "extractInterface", "addImplement", "newField", "newField", "isSubtypeOf", "addComment", "addParameter", "createAdapter", "clone", "isOverriding", "clone", "setArguments", "setArguments", "tile", "tile", "interchange", "setInit", "setLhs", "setRhs", "setOperator", "extract", "setInit", "insertBegin", "insertBegin", "setOperator", "setOperator", "setValue"};
