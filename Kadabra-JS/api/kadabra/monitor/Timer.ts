import { primitive2Class } from "../Utils.ts";
import { newClass } from "../Factory.ts";
import TimerBase from "@specs-feup/lara/api/lara/code/TimerBase.ts";
import { Class, Field, Joinpoint } from "../../Joinpoints.ts";
