...
package weaver.kadabra.monitor.pc.ubuntu;

import java.lang.reflect.Field;

/**
 * This code was retrieved from https://github.com/kliu20/jRAPL/blob/master/EnergyCheckUtils.java <br>
 * <b>NOTE:</b> The program must be executed in sudo or with paranoid level < 1
 * 
 * @author tdrc
 *
 */
public class UbuntuEnergyCheck {
    ...
    /**
     * @return an array of current energy information. The first entry is: Dram/uncore gpu energy(depends on the cpu
     *         architecture. The second entry is: CPU energy The third entry is: Package energy
     */
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < socketNum; i++) {
            System.out.println("Power consumption of dram: " + (after[0] - before[0]) / 10.0
                    + " power consumption of cpu: " + (after[1] - before[1]) / 10.0 + " power consumption of package: "
                    + (after[2] - before[2]) / 10.0);
        }
        ProfileDealloc();
    }
}