...
public class KnobSampling<K, M> implements Comparable<KnobSampling<K, M>> {
    ...
    private KnobExplorationManager<K, M> manager;
    ...
    public KnobSampling(KnobApplier<K> knob, Measurer<M> m, KnobExplorationManager<K, M> manager) {
        this.knob = knob;
        this.measurer = m;
    ...
    public static <K, M> KnobSampling<K, M> newInstance(KnobApplier<K> knob, Measurer<M> m,
            KnobExplorationManager<K, M> manager) {
    ...
    public KnobExplorationManager<K, M> getManager() {
        return manager;
    }

    public void setManager(KnobExplorationManager<K, M> manager) {
        this.manager = manager;
    }
}
