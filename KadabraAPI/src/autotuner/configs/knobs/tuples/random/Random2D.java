 ...
 *
 */
public class Random2D<L extends Number, R extends Number> implements Configuration<Pair<L, R>> {
    ...
    public Random2D(RangedKnob<L> leftRange, RangedKnob<R> rightRange) {
