 ...
 *
 */
public class Random3D<L extends Number, M extends Number, R extends Number>
    ...
    public Random3D(RangedKnob<L> leftRange, RangedKnob<M> middleRange, RangedKnob<R> rightRange) {
