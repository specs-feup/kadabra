 ...
 *
 */
public class Around5D<A extends Number, B extends Number, C extends Number, D extends Number, E extends Number>
    ...
    public Around5D(RangedKnob<A> aRange, RangedKnob<B> bRange, RangedKnob<C> cRange, RangedKnob<D> dRange,
            RangedKnob<E> eRange) {
        this.aRange = aRange;
        this.bRange = bRange;
        this.cRange = cRange;
